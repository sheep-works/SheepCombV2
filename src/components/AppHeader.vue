...
<template>
  <header class="app-header">
    ...
    <nav class="header-nav">
      <router-link to="/parser" class="nav-link" active-class="active">
      ...
      <router-link to="/shuttle" class="nav-link" active-class="active">
      ...
      <router-link to="/api" class="nav-link" active-class="active">
